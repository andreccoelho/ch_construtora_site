import { FooterWrapper, LogoWrapper, SocialIconsRow, LegalText } from "./Style";
...
const Footer = () => {
  return (
    <FooterWrapper id="footer">
      ...
      <SocialIconsRow>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
          <path
            ...
            fill="url(#paint0_linear_44_743)"
          />
          <defs>
            <linearGradient id="paint0_linear_44_743" x1="19.5834" y1="2.5" x2="19.5834" y2="37.5001" gradientUnits="userSpaceOnUse">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
          <path
            ...
            fill="url(#paint0_linear_44_740)"
          />
          <defs>
            <linearGradient id="paint0_linear_44_740" x1="20" y1="6.56006" x2="20" y2="32.8004" gradientUnits="userSpaceOnUse">
              <stop stopColor="#DECB8D" />
              <stop offset="1" stopColor="#807551" />
            </linearGradient>
          </defs>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
          <g clipPath="url(#clip0_44_734)">
            <path
              ...
              fill="url(#paint0_linear_44_734)"
            />
          </g>
          <defs>
            <linearGradient id="paint0_linear_44_734" x1="20" y1="0" x2="20" y2="40.0001" gradientUnits="userSpaceOnUse">
              <stop stopColor="#DECB8D" />
              <stop offset="1" stopColor="#807551" />
            </linearGradient>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
          <path
            ...
            fill="url(#paint0_linear_44_728)"
          />
          <defs>
            <linearGradient id="paint0_linear_44_728" x1="20" y1="0" x2="20" y2="40" gradientUnits="userSpaceOnUse">
              <stop stopColor="#DECB8D" />
              <stop offset="1" stopColor="#807551" />
            </linearGradient>
          </defs>
      ...
      <LegalText>
        Copyright © CH Construtora | CNPJ XX.XXX.XXX/0001-XX | Todos os direitos reservados
      </LegalText>
    </FooterWrapper>
  );
};
